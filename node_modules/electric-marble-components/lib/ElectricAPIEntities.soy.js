...
goog.loadModule(function (exports) {
  ...
  exports.render.types = { "entityData": "?", "project": "?" };
  exports.augments.params = ["augments"];
  exports.augments.types = { "augments": "?" };
  exports.default.params = ["default"];
  exports.default.types = { "default": "?" };
  exports.description.params = ["description"];
  exports.description.types = { "description": "?" };
  exports.entity.params = ["entityData", "project"];
  exports.entity.types = { "entityData": "?", "project": "?" };
  exports.entityHeader.params = ["entityData", "project"];
  exports.entityHeader.types = { "entityData": "?", "project": "?" };
  exports.entityName.params = ["entityData"];
  exports.entityName.types = { "entityData": "?" };
  exports.inlineParams.params = ["params"];
  exports.inlineParams.types = { "params": "?" };
  exports.members.params = ["members", "project"];
  exports.members.types = { "members": "?", "project": "?" };
  exports.param.params = ["param"];
  exports.param.types = { "param": "?" };
  exports.params.params = ["params"];
  exports.params.types = { "params": "?" };
  exports.returns.params = ["returns"];
  exports.returns.types = { "returns": "?" };
